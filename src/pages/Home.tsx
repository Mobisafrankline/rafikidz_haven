  ...
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1e1610]/95 via-[#1e1610]/60 to-[#1e1610]/70" />
      </div>
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 w-full">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-8">
            Every Child<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f0c94a] to-[#eab308]">Deserves</span> a Safe Home.
          </h1>
          ...
          <div className="flex flex-wrap gap-5">
            <Link to="/donate" className="group relative inline-flex items-center justify-center bg-gradient-to-r from-[#eab308] to-[#fde047] text-[#1e1610] px-8 py-4 rounded-full font-bold text-lg overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(234,179,8,0.4)]">
...
function MissionStrip() {
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-[#fefce8] rounded-l-full opacity-50 blur-3xl -z-10 transform translate-x-1/2"></div>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <div className="inline-block bg-[#fefce8] text-[#eab308] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6">Our Mission</div>
            <h2 className="text-4xl md:text-6xl font-extrabold text-[#1e1610] mb-8 leading-[1.1]">
              Turning Hardship Into <span className="text-[#eab308]">Hope</span>
            </h2>
            ...
            <Link to="/about" className="group inline-flex items-center gap-3 text-[#eab308] font-bold text-lg hover:text-[#ca8a04] transition-colors">
              <span className="border-b-2 border-[#eab308] pb-1">Read our full story</span> 
              <span className="group-hover:translate-x-1 transition-transform bg-[#fefce8] p-2 rounded-full">→</span>
            </Link>
          </div>
          <div className="relative group">
            <div className="rounded-[2.5rem] overflow-hidden aspect-[4/5] shadow-2xl shadow-[#eab308]/20 relative z-10">
              <img
            ...
            <div className="absolute -inset-4 border-2 border-[#fefce8] rounded-[3rem] -z-0 translate-x-4 translate-y-4"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-32 bg-[#fefce8]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <span className="inline-block bg-[#eab308]/10 text-[#eab308] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6">What We Provide</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programs.map(p => (
            <Link key={p.title} to={p.link} className="bg-white rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(196,98,45,0.1)] hover:-translate-y-2 transition-all duration-300 group border border-transparent hover:border-[#eab308]/20">
              <div className="w-16 h-16 rounded-2xl bg-[#fefce8] flex items-center justify-center text-3xl mb-6 group-hover:bg-[#eab308] group-hover:text-white transition-colors duration-300 shadow-inner">
                {p.icon}
              </div>
              ...
              <div className="text-[#eab308] font-bold text-sm flex items-center gap-2">
          ...
          {needs.map(n => (
            <div key={n.label} className="flex items-center justify-between glass hover:bg-white/20 rounded-2xl px-6 py-5 transition-all hover:scale-[1.02] cursor-default">
              <div className="flex items-center gap-4">
                <span className={`w-3 h-3 rounded-full shrink-0 shadow-lg ${n.hot ? 'bg-[#eab308] shadow-[#eab308]/50 animate-pulse' : 'bg-white/30'}`} />
...
function DonateCallout() {
  return (
    <section className="py-0 relative -mt-16 z-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-gradient-to-br from-[#eab308] to-[#ca8a04] rounded-[3rem] overflow-hidden shadow-2xl p-10 md:p-16 lg:p-20 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/donate" className="bg-white text-[#eab308] hover:bg-[#fefce8] px-8 py-4 rounded-full font-bold transition-transform hover:scale-105 shadow-xl">
                  Donate Monthly
                </Link>
  ...
  return (
    <section className="py-32 bg-white pt-48 -mt-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <span className="text-[#eab308] text-xs font-bold uppercase tracking-widest mb-4 block">Latest Updates</span>
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#1e1610]">News from the Home</h2>
          </div>
          <Link to="/news" className="group inline-flex items-center gap-2 text-[#eab308] font-bold hover:text-[#ca8a04] transition-colors">
            All news <span className="group-hover:translate-x-1 transition-transform">→</span>
          </Link>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {articles.map(a => (
            <Link key={a.title} to="/news" className="group bg-[#fefce8] rounded-3xl p-8 h-full border border-transparent hover:border-[#eab308]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
              <div className="flex items-center gap-3 mb-6">
                <span className="bg-white text-[#eab308] text-xs font-bold px-3 py-1.5 rounded-full shadow-sm">{a.tag}</span>
                <span className="text-[#8a7968] text-sm font-medium">{a.date}</span>
              </div>
              <h3 className="font-extrabold text-[#1e1610] text-xl mb-4 group-hover:text-[#eab308] transition-colors leading-snug">{a.title}</h3>
              <p className="text-[#6b5c4a] text-sm leading-relaxed font-light flex-grow">{a.excerpt}</p>
              <div className="mt-6 text-[#eab308] font-bold text-sm flex items-center gap-2">
    ...
    <section className="py-16 bg-[#fefce8]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8">
          {partners.map(p => (
            <span key={p} className="text-[#8a7968]/40 font-extrabold text-lg md:text-xl uppercase tracking-wider hover:text-[#eab308] transition-colors cursor-default grayscale hover:grayscale-0">{p}</span>
          ))}
        </div>
      </div>
    </section>
